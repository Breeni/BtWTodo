...
L["Active in about %s"] = "Active in about %s"
L["Next in about %s"] = "Next in about %s"
L["Boss: %s"] = "Boss: %s"
...
-- L["Zul'gath the Flayer"] = "Zul'gath the Flayer" -- db2.criteriatree[91691].Description
-- L["Golmak the Monstrosity"] = "GolMak the Monstrosity" -- db2.criteriatree[91700].Description
-- L["Sentinel Pyrophus"] = "Sentinel Pyrophus" -- db2.criteriatree[91689].Description
-- L["Mugrem the Soul Devourer"] = "Mugrem the Soul Devourer" -- db2.criteriatree[91692].Description
-- L["Kazj the Sentinel"] = "Kazj the Sentinel" -- db2.criteriatree[91696].Description
-- L["Promathiz"] = "Promathiz" -- db2.criteriatree[91688].Description
-- L["Sentinel Shakorzeth"] = "Sentinel Shakorzeth" -- db2.criteriatree[91695].Description
-- L["Intercessor Razzram"] = "Intercessor Razzram" -- db2.criteriatree[91697].Description
-- L["Gruukuuek the Elder"] = "Gruukuuek the Elder" -- db2.criteriatree[91690].Description
-- L["Algel the Haunter"] = "Algel the Haunter" -- db2.criteriatree[91694].Description
...
L["Import"] = "Import"
L["Update"] = "Update"
L["Import Todo"] = "Import Todo"
L["Importing todo \"%s\""] = "Importing todo \"%s\""
L["Skyriding Talents"] = "Skyriding Talents"
L["Kej"] = "Kej" -- db2.currencytypes[3750].Name
L["Resonance Crystals"] = "Resonance Crystals" -- db2.currencytypes[2815].Name
L["Undercoin"] = "Undercoin" -- db2.currencytypes[2803].Name
L["Valorstones"] = "Valorstones" -- db2.currencytypes[3008].Name
L["Weathered Harbinger Crest"] = "Weathered Harbinger Crest" -- db2.currencytypes[2914].Name
L["Carved Harbinger Crest"] = "Carved Harbinger Crest" -- db2.currencytypes[2915].Name
L["Runed Harbinger Crest"] = "Runed Harbinger Crest" -- db2.currencytypes[2916].Name
L["Gilded Harbinger Crest"] = "Gilded Harbinger Crest" -- db2.currencytypes[2917].Name
L["Council of Dornogal"] = "Council of Dornogal" -- db2.faction[2590].Name
L["The Assembly of the Deeps"] = "The Assembly of the Deeps" -- db2.faction[2594].Name
L["Hallowfall Arathi"] = "Hallowfall Arathi" -- db2.faction[2570].Name
L["The Severed Threads"] = "The Severed Threads" -- db2.faction[2600].Name
L["The War Within"] = "The War Within" -- EXPANSION_NAME10
